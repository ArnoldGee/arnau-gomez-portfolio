  ...
  return (
    <article className={styles.hero}>
      ...
      <article className={styles.heroContainer}>
        <Section noPaddingBottom noPaddingTop>{children}</Section>
      </article>
      <svg
        className={styles.heroSVG}
      ...
      >
        <path
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          d="M1440 52.322l-10 11.27c-10 11.671-30 35.015-50 28.978-20-5.635-40-40.248-60-34.613-20 5.635-40 52.322-60 72.446-20 20.124-40 14.489-60 11.672-20-2.818-40-2.818-60-8.855-20-5.635-40-17.306-60-14.489s-40 20.526-60 14.489c-20-5.635-40-34.613-60-43.467-20-8.453-40 2.817-60 17.306s-40 32.198-60 20.526c-20-11.671-40-52.322-60-63.993-20-11.27-40 6.037-60 11.671-20 6.037-40 0-60 0s-40 6.037-60 11.672c-20 5.635-40 11.672-60 26.161s-40 37.431-60 26.161c-20-11.672-40-57.957-60-63.994-20-5.634-40 28.979-60 28.979s-40-34.613-60-40.65c-20-5.635-40 17.709-60 23.343-20 5.635-40-5.635-60-20.124-20-14.489-40-32.198-60-32.198s-40 17.71-60 23.344c-20 5.635-40 0-50-2.818L0 52.322V0h1440v52.322z"
        />
      </svg>
    </article>
  );
